...
var client_id = client.config.getSync("spotikook::api.client.id");
var client_secret = client.config.getSync("spotikook::api.client.secret");
...
app.listen(port);
client.logger.info("Server started listening on port " + port);